            ...
            <div class="container">
                <main>
                    ...
                    <div class="col-md-7 col-lg-8">
                        ...
                        <form class="needs-validation" action="C_espo.php" novalidate method="post" enctype='multipart/form-data'>
                        <div class="row g-3">
                            <div class="col-sm-6">
                            <label for="data_revelacao" class="form-label">Data da Revelação</label>
                            <input type="date" class="form-control" id="data_revelacao" name="data_revelacao" required>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="com_deficiencia" name="com_deficiencia" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="responsavel_legal" name="responsavel_legal" required>
                            </div>
                            </div>
                            ...
                            <select class="form-select" id="cidade" name="cidade" required>
                                <option></option>
                                <option>Serra do Ramalho</option>
                            </select>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" name="telefone" id="telefone" class="form-control" onkeyup="formatarTelefone(this)" maxlength="11" required/>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="r_atend" name="rede_atendimento" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="violacao" name="violacao" required>
                            </div>
