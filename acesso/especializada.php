        ...
        <div class="content">
            ...
            <div class="container">
                <main>
                    ...
                    <h2>FICHA NOTIFICAÇÃO DE ESCUTA ESPECIALIZADA</h2>
                    <p class="lead">...</p>
                    </div>
                    ...
                    <div class="col-md-7 col-lg-8">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="ende_orgao" name="ende_orgao" required>
                                <div class="invalid-feedback">
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" id="telefone" name="telefone" class="form-control" onkeyup="formatarTelefone(this)" maxlength="11" required>
                                <div class="invalid-feedback">
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="nome_crianca" name="nome_crianca" required>
                            </div>
                            </div>
                            ...
                            <div class="form-check">
                                <input id="deficiencia" name="deficiencia" type="radio" class="form-check-input" required value="Sim">
                                <label class="form-check-label" for="deficiencia">Sim</label>
                            </div>
                            <div class="form-check">
                                <input id="deficiencia" name="deficiencia" type="radio" class="form-check-input" required value="São">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="tecnologia_assistiva" name="tecnologia_assistiva" required>
                            </div>
                            </div>
                            ...
                            <div class="form-check">
                                <input id="sexo" name="sexo" type="radio" class="form-check-input" name="sexo"  required value="Masculino">
                                <label class="form-check-label" for="sexo">Masculino</label>
                            </div>
                            <div class="form-check">
                                <input id="sexo" name="sexo" type="radio" class="form-check-input" name="sexo" required value="Feminino">
                            ...
                            <div class="form-check">
                                <input id="situacao_moradia" name="situacao_moradia" type="radio" class="form-check-input"  required value="Acolhimento">
                                <label class="form-check-label" for="situacao_moradia">Acolhimento</label>
                            </div>
                            <div class="form-check">
                                <input id="situacao_moradia" name="situacao_moradia" type="radio" class="form-check-input" required value="Cumprimento de medida Sócio-educativa">
                                <label class="form-check-label" for="situacao_moradia">Cumprimento de medida Sócio-educativa</label>
                            </div>
                            <div class="form-check">
                                <input id="situacao_moradia" name="situacao_moradia" type="radio" class="form-check-input" required value="Situação de Rua">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" id="tel_responsavel" class="form-control" name="tel_responsavel" onkeyup="formatarTelefone(this)" maxlength="11" required>
                                <div class="invalid-feedback">
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="email_responsavel" name="email_responsavel" required>
                            </div>
                            </div>  
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="escolaridade_respon" name="escolaridade_respon" required>
                            </div>
                            </div>  
                            ...
                            <div class="form-check">
                                <input id="irmao" name="irmao" type="radio" class="form-check-input"  name="irmao" required value="Sim">
                                <label class="form-check-label" for="irmao">Sim</label>
                            </div>
                            <div class="form-check">
                                <input id="irmao" name="irmao" type="radio" class="form-check-input" name="irmao" required value="Não">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="quanti_irmao" name="quanti_irmao" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="quant_pessoas" name="quant_pessoas" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="tipo_violacao" name="tipo_violacao" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="endereco_autor" name="endereco_autor" required>
                            </div>
                            </div> 
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="relacao_autor" name="relacao_autor" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="processo_jud" name="processo_jud" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="med_prote_ante" name="med_prote_ante" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="historico_autor" name="historico_autor" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="historico_vitima" name="historico_vitima" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="historico_familia" name="historico_familia" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="risco_local" name="risco_local" required>
                            </div>
                            </div>
                            ...
                            <div class="form-check">
                                <input id="testemunha" name="testemunha" type="radio" class="form-check-input" name="testemunha"  required value="Sim">
                                <label class="form-check-label" for="testemunha">Sim</label>
                            </div>
                            <div class="form-check">
                                <input id="testemunha" name="testemunha" type="radio" class="form-check-input" name="testemunha" required value="Não">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="testemunhas" name="testemunhas" required>
                                <div class="invalid-feedback">
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="contato_testemunha" name="contato_testemunha" required>
                                <div class="invalid-feedback">
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="acompanhamento" name="acompanhamento" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="atendimento_vit" name="atendimento_vit" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="tratamento_diario" name="tratamento_diario" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="acomp_psicologico" name="acomp_psicologico" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="local_estuda" name="local_estuda" required>
                            </div>
                            </div>
                            ...
                            <div class="form-check">
                                <input id="documentacao" name="documentacao" type="radio" class="form-check-input" name="documentacao"  required value="Certidão de nascimento">
                                <label class="form-check-label" for="documentacao">Certidão de nascimento</label>
                            </div>
                            <div class="form-check">
                                <input id="documentacao" name="documentacao" type="radio" class="form-check-input" name="documentacao" required value="Carteira de identidade">
                                <label class="form-check-label" for="documentacao">Carteira de identidade</label>
                            </div>
                            <div class="form-check">
                                <input id="documentacao" name="documentacao" type="radio" class="form-check-input" name="documentacao"  required value="Título eleitoral">
                                <label class="form-check-label" for="documentacao">Título eleitoral</label>
                            </div>
                            <div class="form-check">
                                <input id="documentacao" name="documentacao" type="radio" class="form-check-input" name="documentacao"  required value="CPF">
                            ...
                            <div class="form-check">
                                <input id="cad_unico" name="cad_unico" type="radio" class="form-check-input" name="cad_unico"  required value="Sim">
                                <label class="form-check-label" for="cad_unico">Sim</label>
                            </div>
                            <div class="form-check">
                                <input id="cad_unico" name="cad_unico" type="radio" class="form-check-input" name="cad_unico" required value="Não">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="rede_atendimento" name="rede_atendimento" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="bpc_" name="bpc_"  required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="bpc" name="bpc" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="violacao_direitos" name="violacao_direitos" required>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="fragilidade_familiar" name="fragilidade_familiar" required>
                            </div>
                            </div>
                            ...
                            <div class="form-check">
                                <input id="conselho_tutelar" name="conselho_tutelar" type="radio" class="form-check-input" name="conselho_tutelar"  required value="Sim">
                                <label class="form-check-label" for="conselho_tutelar">Sim</label>
                            </div>
                            <div class="form-check">
                                <input id="conselho_tutelar" name="conselho_tutelar" type="radio" class="form-check-input" name="conselho_tutelar" required value="Não">
                            ...
                            <div class="input-group has-validation">
                                <textarea type="text" class="form-control" id="med_protetiva" name="med_protetiva" required></textarea>
                            </div>
                            </div>
                            ...
                            <div class="input-group has-validation">
                                <textarea type="text" class="form-control" id="relato_crianca" name="relato_crianca"  required></textarea>
                            </div>
                            </div>
